package demos.compose.desktop.calculator.v2
...
import demos.compose.desktop.calculator.v2.Operation.*
...
fun main() = Window(title = "Calculator via Compose for Desktop V2", size = IntSize(375, 325)) {
